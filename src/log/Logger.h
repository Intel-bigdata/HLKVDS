...
#include <vector>
#include <log/IAppender.h>
#include <log/Util.h>


#ifndef LOG_DEFAULT_INSTANCE
#   define LOG_DEFAULT_INSTANCE 0
#endif
...
namespace kvdb
{
    ...
    inline Logger<LOG_DEFAULT_INSTANCE>* get()
    {
        return Logger<LOG_DEFAULT_INSTANCE>::getInstance();
    }
}
